...
/**
 * {@code /war declare|withdraw|status|list} and the staff cancel command. Surrender isn't implemented
 * here — it requires the settlement clause pipeline (Stage 18), out of scope for the phase skeleton.
 */
